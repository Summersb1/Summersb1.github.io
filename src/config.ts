...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/Summersb1',     // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
  ...
  name: 'Summersb1',
  bio: 'A tech otaku who loves games from Hoyoverse.',
  links: [
    {
      name: 'Ko-fi',
